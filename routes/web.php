...
use App\Http\Controllers\Blade\BugDemoController;
...
Route::prefix('blade')->group(function () {
    ...
    Route::get('bug-ok', [BugDemoController::class, 'ok'])->name('blade.bug.ok');
    Route::get('bug-bug', [BugDemoController::class, 'bug'])->name('blade.bug.bug');
});
