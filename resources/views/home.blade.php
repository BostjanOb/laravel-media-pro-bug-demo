...
@section('content')
    ...
    <x-h2 class="mt-12">Bug demo</x-h2>
    <ul class="list-disc list-inside">
        <li>
            <x-list-link route="blade.bug.ok">Working partial</x-list-link>
        </li>
        <li>
            <x-list-link route="blade.bug.bug">Not working partial</x-list-link>
        </li>
    </ul>
